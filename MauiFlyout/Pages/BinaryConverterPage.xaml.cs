...
{
    /// <summary>
    /// Page for converting numbers between binary and decimal.
    /// Allows conversions from binary to decimal and vice versa.
    /// </summary>
    public partial class BinaryConverterPage : ContentPage
    {
        /// <summary>
        /// Constructor of the page. Initializes the components of the interface.
        /// </summary>
        public BinaryConverterPage()
        {
            InitializeComponent();
        }
